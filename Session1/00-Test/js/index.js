...
function geometry(){
  ...
  material = new THREE.MeshBasicMaterial({map:texture1,shininess: 2000,});
...
var render = function () {
  ...
  mesh.rotation.x += 0.01; //Continuously rotate the 球1
  mesh.rotation.y += 0.01;

  mesh1.rotation.x += 0.02; //Continuously rotate the 环2
  mesh1.rotation.y += 0.06;

  mesh2.rotation.x += 0.005; //Continuously rotate the 黑球2
  mesh2.rotation.y += 0.005;

  mesh3.rotation.x += 0.003; //Continuously rotate the 最小球3
  mesh3.rotation.y += 0.003;

  mesh4.rotation.x += 0.04; //Continuously rotate the 环1
  mesh4.rotation.y += 0.06;

  mesh5.rotation.x += 0.005; //Continuously rotate the 环3
  mesh5.rotation.y += 0.005;

  mesh6.rotation.x += 0.004; //Continuously rotate the 左上黄球
  mesh6.rotation.y += 0.006;

  mesh7.rotation.x += 0.009; //Continuously rotate the 左上环
  mesh7.rotation.y += 0.009;

  mesh8.rotation.x += 0.004; //Continuously rotate the 左上环
